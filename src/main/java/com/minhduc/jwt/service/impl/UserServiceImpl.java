...
//        User userEntity = mapper.map(user, User.class);
        ...
        userEntity.getRoles().stream().forEach(role -> System.out.println(role.getRoleEnum().name()));
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        UserDetailsBuilder userDetailsBuilder = new UserDetailsBuilder(userEntity.getEmail(), userEntity.getEncryptedPassword(), authorities);
